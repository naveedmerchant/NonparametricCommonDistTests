...
The maximum of two elements is either the first element or the second one. If its the first element, then the lower bound is:
 ...
 $\frac{1}{B_1 \sqrt{\pi}} * \frac{1}{ \mathbf{B}(\frac{n_{1} -1}{2}, \frac{n_1 -1}{2})} * \frac{ (\sum_{D=1}^\infty \frac{((n_{21}))^{-D}\sum_{k=0}^{\infty} \binom{2D+k-1}{k}E[{X^k}]E[{X^{-2D-k}}]}{B_1^{2*(D-1)}})^{n_{21} - .5} + (\sum_{D=0}^\infty \frac{((n_{22}))^D \sum_{i=0}^{2D} (-1)^i \binom{2D}{i}E[X^{2D-i}]E[X^{i}]}{B_1^{2D+2}})^{n_{22}- .5}}{4(\sum_{D=1}^\infty \frac{(.5n_{21})^{-D}\sum_{k=0}^{\infty} \binom{2D+k-1}{k}E[{X^k}]E[{X^{-2D-k}}]}{B_1^{2*(D-1)}})^{{n_{21}} - 1}}$
...
$ \frac{1}{B_1 \sqrt{\pi}} * \frac{1}{ \mathbf{B}(\frac{n_{1} -1}{2}, \frac{n_1 -1}{2})} * \frac{ (\sum_{D=1}^\infty \frac{((n_{21}))^{-D}\sum_{k=0}^{\infty} \binom{2D+k-1}{k}E[{X^k}]E[{X^{-2D-k}}]}{B_1^{2*(D-1)}})^{n_{21} - .5} + (\sum_{D=0}^\infty \frac{((n_{22}))^D \sum_{i=0}^{2D} (-1)^i \binom{2D}{i}E[X^{2D-i}]E[X^{i}]}{B_1^{2D+2}})^{n_{22}- .5}}{4(\sum_{D=0}^\infty \frac{(.5n_{22})^D \sum_{i=0}^{2D} (-1)^i \binom{2D}{i}E[X^{2D-i}]E[X^{i}]}{B_1^{2D+2}})^{{n_{22}} - 1}}$
